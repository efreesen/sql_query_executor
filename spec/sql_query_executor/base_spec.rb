...
describe SqlQueryExecutor, "Base" do
  before do
    ...
    @data << {:id => 5, :name => "Brazil", :founded_at => Time.parse('1500-04-22 13:34:25 -0300')}
  end
  ...
  describe ".where" do
    describe "=" do
      ...
      context "when attribute is datetime" do
        it "matches a record" do
          record = subject.where("founded_at = ?", Time.parse('1500-04-22 13:34:25 -0300'))
          record.count.should == 1
        ...
        it "doesn't match any record" do
          record = subject.where("id = ?", Time.parse('1500-09-07 13:34:25 -0300'))
          record.count.should == 0
          record.should == []
        end
      end
    ...
    describe ">" do
      ...
      context "when attribute is datetime" do
        it "matches a record" do
          record = subject.where("founded_at > ?", Time.parse('1500-04-20 13:34:25 -0300'))
          record.count.should == 1
          record.first.id.should == 5
          record.first.name.should == 'Brazil'
        end
        ...
        it "doesn't match any record" do
          record = subject.where("founded_at > ?", Time.parse('1500-04-23 13:34:25 -0300'))
          record.count.should == 0
          record.should == []
        end
      end
    ...
    describe "<" do
      ...
      context "when attribute is datetime" do
        it "matches a record" do
          record = subject.where("founded_at < ?", Time.parse('1500-04-22 13:34:26 -0300'))
          record.count.should == 1
          record.first.id.should == 5
          record.first.name.should == 'Brazil'
        end
    ...
    describe "<=" do
      ...
      context "when attribute is datetime" do
        ...
        it "doesn't match any record" do
          record = subject.where("founded_at <= ?", Time.parse('1500-04-22 13:34:24 -0300'))
          record.count.should == 0
          record.should == []
        end
      end
    ...
    describe "between" do
      ...
      context "when attribute is datetime" do
        it "matches a record" do
          record = subject.where("founded_at between ? and ?", Time.parse('1500-04-22 13:34:24 -0300'), Time.parse('1500-04-22 13:34:26 -0300'))
          record.count.should == 1
          record.first.id.should == 5
          record.first.name.should == 'Brazil'
        end
        ...
        it "doesn't match any record" do
          record = subject.where("founded_at between ? and ?", Time.parse('1500-04-22 13:34:26 -0300'), Time.parse('1500-09-22 13:34:25 -0300'))
          record.count.should == 0
          record.should == []
        end
      end
